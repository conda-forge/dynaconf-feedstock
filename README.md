...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dynaconf-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11021&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dynaconf-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dynaconf` can be installed with:

```
conda install dynaconf
```

It is possible to list all of the versions of `dynaconf` available on your platform with:
